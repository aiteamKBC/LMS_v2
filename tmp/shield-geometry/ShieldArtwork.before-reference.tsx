...
// The top panels rise towards the crown; the lower pair follows the shield's taper.
// The same outline paints each panel and clips its interactive hit area.
const upperPanel = 'M90 108 C350 100 670 43 870 8 C938 -4 996 45 996 117 L996 902 Q996 996 902 996 L94 996 Q4 996 4 906 L4 192 Q4 112 90 108Z';
const lowerPanel = 'M100 4 H900 Q996 4 996 100 V875 Q996 955 910 966 L360 995 C202 1003 126 924 78 792 C27 634 4 390 4 130 Q4 4 100 4Z';
