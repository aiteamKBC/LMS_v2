...
function LearningShield({ dashboardHref }: { dashboardHref: string }) {
  return <section className={styles.shield} aria-label="Learning actions">
    <svg className={styles.shieldShape} viewBox="0 0 1000 1270" aria-hidden="true">
      <defs>
        ...
        <path id="learning-shield-outline" d="M500 9 C650 84 817 132 982 156 Q991 157 991 174 C991 420 991 702 965 889 C958.5 935.75 952.5 978.5 930 1016 C905 1058 857 1102 800 1143 C761 1171 724 1186.82 675 1206.5 C614 1231 551 1251 500 1261 C449 1251 386 1231 325 1206.5 C276 1186.82 239 1171 200 1143 C143 1102 95 1058 70 1016 C47.5 978.5 41.5 935.75 35 889 C9 702 9 420 9 174 Q9 157 18 156 C183 132 350 84 500 9Z"/>
      </defs>
      <use href="#learning-shield-outline" fill="url(#shield-purple)" stroke="url(#shield-gold)" strokeWidth="18" strokeLinejoin="round"/>
    ...
    <Link className={styles.continue} to="/learner/my-learning" aria-label="Continue Learning"><ReferenceIcon name="graduate"/>
      <span>Continue<br/>Learning</span><ArrowRight aria-hidden="true"/></Link>
