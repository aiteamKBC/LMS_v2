...
<td align="left" valign="top" width="54%" style="width:54%;padding:14px 12px;font-family:Arial,Helvetica,sans-serif;border-bottom:1px solid #e9edf3;vertical-align:top;"><span style="font-size:10px;color:#7b8192;line-height:16px;">SESSION {number:02}</span><br><strong style="font-size:13px;line-height:21px;color:#243247;">{escape(date_label(start))}</strong></td>
