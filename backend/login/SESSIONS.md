...
- The ordinary rolling window is 5 hours: long enough that a full working
  sitting with the console open but untouched is never interrupted, short
  enough that a device left with no request for that long is treated as
  unattended and signed out.
