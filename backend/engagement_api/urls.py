...
urlpatterns = [
    ...
    path('feedback/forms/<int:pk>/recipients/', feedback.form_recipients, name='feedback-form-recipients'),
    ...
    path('feedback/my-forms/<int:pk>/questions/<int:question_id>/photo/', feedback.learner_photo_upload, name='feedback-photo-upload'),
