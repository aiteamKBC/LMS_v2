...
urlpatterns = [
    ...
    path('coach/timetable/busy-slots', coach_learner_busy_slots, name='coach-timetable-busy-slots'),
    path('coach/learners/<int:learner_id>/busy-slots', coach_learner_busy_slots, name='coach-learner-busy-slots'),
