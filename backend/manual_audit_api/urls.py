...
from .plan_pickers import (
    ...
    picker_ksbs,
    picker_lms_course_materials,
    picker_lms_courses,
    picker_lms_groups,
    picker_material_content,
    picker_materials,
...
urlpatterns = [
    ...
    path("plan/pickers/lms-courses", picker_lms_courses, name="manual-plan-picker-lms-courses"),
    path("plan/pickers/lms-course-materials", picker_lms_course_materials, name="manual-plan-picker-lms-course-materials"),
    path("plan/pickers/material-content", picker_material_content, name="manual-plan-picker-material-content"),
