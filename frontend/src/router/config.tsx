...
const page.MonthlyCoachingListPage = lazy(() => import("../pages/learner/monthly-coaching/page").then(m => ({ default: m.MonthlyCoachingListPage })));
...
import MonthlyCoachingPage, * as page from "../pages/learner/monthly-coaching/page";
...
const routes: RouteObject[] = [
  ...
  },
  {
    ...
    element: <page.MonthlyCoachingListPage />,
  },
  {
