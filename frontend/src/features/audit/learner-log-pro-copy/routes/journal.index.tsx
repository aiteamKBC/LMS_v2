      ...
      <main className="mx-auto max-w-[88rem] space-y-6 px-6 py-8">
        <section className="rounded-lg border border-border bg-card p-7 shadow-panel">
          <div className="flex flex-wrap items-start justify-between gap-5 border-b border-border pb-6">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">Generated live from <span className="font-mono">Audit.learner_match</span>.</p>
            </div>
            <Button
              className="gap-2"
        ...
        <section className="rounded-lg border border-border bg-card shadow-panel">
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader><TableRow className="hover:bg-transparent"><TableHead className="label-caps pl-7">Plan ID</TableHead><TableHead className="label-caps">Date</TableHead><TableHead className="label-caps">Activity</TableHead><TableHead className="label-caps">Category</TableHead><TableHead className="label-caps">Timestamp</TableHead><TableHead className="label-caps text-right">Planned</TableHead><TableHead className="label-caps pr-7 text-right">Actual</TableHead></TableRow></TableHeader>
              <TableBody>
