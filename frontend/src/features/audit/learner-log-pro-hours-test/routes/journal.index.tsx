...
import { ActualHoursPanel } from "@/features/audit/learner-log-pro-hours-test/components/ActualHoursPanel";
import { JournalHoursControls } from "@/features/audit/learner-log-pro-hours-test/components/JournalHoursControls";
import { useJournalHours } from "@/features/audit/learner-log-pro-hours-test/lib/useJournalHours";
import { AddManualActivityFlow } from "@/features/audit/learner-log-pro-hours-test/components/AddManualActivityFlow";
import { ledgerRef, ManualActivityRow, ManualActivityTableHeader } from "@/features/audit/learner-log-pro-hours-test/components/ManualActivityRow";
import { RetrieveActivitiesPanel } from "@/features/audit/learner-log-pro-hours-test/components/RetrieveActivitiesPanel";
import { Button } from "@/features/audit/learner-log-pro-hours-test/components/ui/button";
import { Table, TableBody, TableHeader } from "@/features/audit/learner-log-pro-hours-test/components/ui/table";
import { getLearnerProfile, getLearners } from "@/features/audit/learner-log-pro-hours-test/lib/api";
import {
...
import {
  ...
  visibleDraftRows,
  type DraftRow,
} from "@/features/audit/learner-log-pro-hours-test/lib/journalDraft";
import { monthBounds } from "@/features/audit/learner-log-pro-hours-test/lib/ukCalendar";
import { downloadLearnerJournalPdf } from "@/features/audit/learner-log-pro-hours-test/lib/journal-pdf";
...
function JournalPage() {
  ...
  // Calculated actual hours awaiting approval for the open learner/month. The
  // journal rows themselves are untouched until an auditor approves.
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto w-full max-w-[1700px] space-y-6 px-6 py-8">
        ...
        {/* Actual Hours review — reads and writes the CLONE branch only, and
            only ever for the learner and month selected above. */}
        <ActualHoursPanel aptemId={aptemId} month={selectedPeriod} learnerName={learnerName} />
      </main>
