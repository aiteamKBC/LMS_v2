...
// /hours_test_api/last-audit/manual/* Django endpoints.

const MANUAL_BASE = "/hours_test_api/last-audit/manual";
...
const EVIDENCE_BASE = "/hours_test_api/last-audit/evidence";
