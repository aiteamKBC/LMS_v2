...
export const roleNotifications: Record<string, RoleNotification[]> = {
  ...
  admin: [
    ...
    { id: 2, text: 'QA failure: Evidence pack EV-2024-442 requires urgent action', time: '2 hours ago', unread: true, type: 'qa', category: 'QA', link: '/admin/messages' },
    ...
    { id: 4, text: 'New tenant onboarding request: TechKent Ltd (3 learners)', time: 'Yesterday', unread: false, type: 'tenant', category: 'Tenants', link: '/admin/tenants' },
    { id: 5, text: 'Automation triggered: 42 learners notified of attendance warning', time: 'Yesterday', unread: false, type: 'automation', category: 'Automation', link: '/admin/automations' },
    ...
    { id: 7, text: 'Bulk user import completed: 12 new users onboarded successfully', time: '3 days ago', unread: false, type: 'users', category: 'Users', link: '/admin/users' },
