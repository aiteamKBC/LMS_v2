...
export const USER_GUIDES: GuideSection[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      { step: 5, title: 'Create Assessments', description: 'The Assessment Design section shows the Quiz Workspace, Question Bank, Quiz Archive, and Checkpoints. Click to create quiz questions, reuse saved questions, and design checkpoint assessments.', icon: 'ri-question-answer-line', action: 'Navigate to Quiz Workspace or Question Bank' },
