...
import { createTeamsMeeting, updateTeamsMeetingSchedule, loadTeamsMeetingConfiguration, fetchModuleMeetingInvitees, fetchModuleSessionPlan, restoreModuleTeamsMeeting, readModuleTeamsMeeting, CurriculumRequestTimeout, ApiError, type SavedModuleTeamsMeeting } from '../moduleAuthoringData';
...
it('loads the existing calendar, updates the same identity and restores its component links', async () => {
  ...
  expect(screen.getByText('Egypt: Fri, 23 Oct 2026, 09:00 AM')).toBeInTheDocument();
  expect(screen.getByText('England: Fri, 30 Oct 2026, 07:00 AM')).toBeInTheDocument();
