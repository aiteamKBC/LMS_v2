...
/* ═══════════════════════════════════════════════════
   BODY — mock (demo) Off-the-Job Hours content, shared
   between the standalone route and the "My Progress" tab.
   ═══════════════════════════════════════════════════ */
export function MockOtjhBody({ showHero = true }: { showHero?: boolean }) {
  ...
  return (
    <div className={showHero ? 'space-y-5 md:space-y-6' : 'space-y-4 md:space-y-5'}>
