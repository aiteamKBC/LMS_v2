          ...
          <div className="relative flex flex-col lg:flex-row items-stretch min-h-[170px]">
            <div className="flex-1 px-5 md:px-7 py-5 md:py-6 flex flex-col justify-center min-w-0">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-foreground-500">9–15 Jun 2026</span>
              ...
              <h1 className="text-lg md:text-xl font-heading font-bold text-primary-800 tracking-tight mb-1.5">Understanding Customer Segmentation and Campaign Targeting</h1>
              <p className="text-sm text-foreground-500">Module: Marketing Planning and Campaign Delivery</p>
            </div>
