      ...
      <div className="p-6 md:p-8">
        <div className="flex items-center gap-2 mb-6">
          <div className="w-8 h-8 rounded-lg bg-accent-100 flex items-center justify-center">
            <i className="ri-calendar-2-line text-accent-700" />
          </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center shrink-0">
                    <i className="ri-calendar-line text-primary-700" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center shrink-0">
                    <i className="ri-time-line text-primary-700" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center shrink-0">
                    <i className="ri-map-pin-line text-primary-700" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center shrink-0">
                    <i className="ri-loop-left-line text-primary-700" />
                  </div>
                  <div>
              ...
              <div className="mt-4 pt-3 border-t border-background-200/30 flex items-center gap-2 text-xs text-foreground-500">
                {meeting.calendarInvitationSent && (
                  <span className="flex items-center gap-1">
                    <i className="ri-check-line text-green-500" /> Calendar invitation sent
                  </span>
                )}
                {meeting.meetingConfirmed && (
                  <span className="flex items-center gap-1">
                    <i className="ri-check-line text-green-500" /> Meeting confirmed
                  </span>
                )}
              </div>
            </div>
