...
const CONTACTS: Contact[] = [
  { id: 'med-maher', name: 'Med Maher', role: 'Progress Coach', initials: 'MM', avatarColor: 'bg-primary-100 text-primary-700', online: true, lastSeen: 'Active now' },
  { id: 'crispin-jones', name: 'Crispin Jones', role: 'Tutor', initials: 'CJ', avatarColor: 'bg-accent-100 text-accent-700', online: false, lastSeen: 'Last seen 2h ago' },
  { id: 'lauren-mitchell', name: 'Lauren Mitchell', role: 'Line Manager', initials: 'LM', avatarColor: 'bg-secondary-100 text-secondary-700', online: true, lastSeen: 'Active now' },
  { id: 'learner-support', name: 'Learner Support', role: 'KBC Support Team', initials: 'LS', avatarColor: 'bg-primary-100 text-primary-700', online: true, lastSeen: 'Active now' },
  { id: 'rebecca-okonkwo', name: 'Rebecca Okonkwo', role: 'Marketing Club Ambassador', initials: 'RO', avatarColor: 'bg-accent-100 text-accent-700', online: false, lastSeen: 'Last seen 1d ago' },
  { id: 'sarah-mitchell', name: 'Sarah Mitchell', role: 'Fellow Apprentice', initials: 'SM', avatarColor: 'bg-secondary-100 text-secondary-700', online: true, lastSeen: 'Active now' },
];

const THREADS: MessageThread[] = [
  { id: 'th-01', contact: CONTACTS[0], lastMessage: 'Looking forward to our coaching session on the 18th. Please prepare your reflection...', lastTime: '2h ago', unread: 2 },
  { id: 'th-02', contact: CONTACTS[1], lastMessage: 'I have uploaded the recording of last week\'s session on the marketing environment...', lastTime: 'Yesterday', unread: 0 },
  { id: 'th-03', contact: CONTACTS[2], lastMessage: 'Great to see the segmentation thinking in the team meeting. Let\'s discuss at our...', lastTime: '3 Jun', unread: 0 },
  { id: 'th-04', contact: CONTACTS[3], lastMessage: 'Thank you for your ticket. We have escalated the evidence upload issue to IT and...', lastTime: '9 Jun', unread: 1 },
  { id: 'th-05', contact: CONTACTS[4], lastMessage: 'The Marketing Club workshop on social media strategy is confirmed for 20 June...', lastTime: '7 Jun', unread: 0 },
  { id: 'th-06', contact: CONTACTS[5], lastMessage: 'Hi Sophie! Would you be up for doing a joint reflection session before the...', lastTime: '5 Jun', unread: 0 },
];

const SAMPLE_MESSAGES: Record<string, Message[]> = {
  'th-01': [
    { id: 'm01', from: 'them', text: 'Hi Sophie! Just checking in ahead of our coaching session on the 18th. How is Week 4 going so far?', time: '10:30 AM', date: '8 Jun 2026', status: 'read' },
    { id: 'm02', from: 'me', text: 'Hi Med! Week 4 is going well thanks. I have completed the STP worksheet and the customer persona activity is nearly done. I am finding the segmentation theory really useful for understanding our different customer groups at Tim Hortons.', time: '11:45 AM', date: '8 Jun 2026', status: 'read', reactions: { '👍': ['Med Maher'] } },
    { id: 'm03', from: 'them', text: 'That is exactly what we want to hear! Can you prepare a short reflection before our session on how you have applied the segmentation learning to your day-to-day work? Bring a specific example from Tim Hortons — perhaps the breakfast vs lunch customer split you mentioned to Lauren.', time: '2:15 PM', date: '8 Jun 2026', status: 'read', reactions: { '❤️': ['Sophie'] } },
    { id: 'm04', from: 'me', text: 'Will do! I have already started noting down examples. Our breakfast customers are very different from our lunch crowd in terms of what they buy and why they visit. I have been observing this at our Canterbury branch.', time: '3:00 PM', date: '8 Jun 2026', status: 'read', reactions: { '👍': ['Med Maher'], '🔥': ['Med Maher'] } },
    { id: 'm05', from: 'them', text: 'Looking forward to our coaching session on the 18th. Please prepare your reflection on how the segmentation learning has impacted your day-to-day work at Tim Hortons. Also, check your OTJH — you are slightly behind pace at 74 hours. Let us discuss a catch-up plan.', time: '4:30 PM', date: '8 Jun 2026', status: 'read', replies: [
      { id: 'm05-r1', from: 'me', text: 'Noted Med! I will make sure to prepare the reflection and have a look at the OTJH dashboard before our session. Thanks for the heads up.', time: '4:35 PM', date: '8 Jun 2026', status: 'read', replyTo: 'm05' },
    ] },
    { id: 'm06', from: 'them', text: 'One more thing — your evidence for Week 3 was strong. Keep linking to KSB K5, K6, and S8. See you on the 18th!', time: '4:32 PM', date: '8 Jun 2026', status: 'read', reactions: { '👏': ['Sophie'] } },
    { id: 'cl-m01', from: 'me', text: 'Voice call • 5 min 30 sec', time: '2:45 PM', date: '5 Jun 2026', callType: 'voice', callDuration: 330, callStatus: 'completed', status: 'read' },
    { id: 'cl-m02', from: 'them', text: 'Video call • 12 min', time: '11:20 AM', date: '3 Jun 2026', callType: 'video', callDuration: 720, callStatus: 'completed', status: 'read' },
    { id: 'cl-m03', from: 'them', text: 'Missed voice call', time: '9:05 AM', date: '2 Jun 2026', callType: 'voice', callStatus: 'missed', status: 'read' },
  ],
  'th-02': [
    { id: 'm07', from: 'them', text: 'I have uploaded the recording of last week\'s session on the marketing environment. Please watch before Wednesday if you missed it.', time: '3:20 PM', date: '6 Jun 2026', status: 'read' },
    { id: 'm08', from: 'me', text: 'Thank you Crispin! I will watch it tonight. I saw the session covered PESTLE analysis — I have actually started applying that to understand the wider factors affecting Tim Hortons in the UK market. Really interesting stuff.', time: '4:00 PM', date: '6 Jun 2026', status: 'read', reactions: { '👍': ['Crispin Jones'], '❤️': ['Crispin Jones'] } },
    { id: 'cl-c01', from: 'them', text: 'Video call • 22 min 15 sec', time: '3:30 PM', date: '4 Jun 2026', callType: 'video', callDuration: 1335, callStatus: 'completed', status: 'read' },
  ],
};

const AUTO_REPLIES: Record<string, string[]> = {
  'th-01': [
    'Great, looking forward to it! See you on the 18th.',
    'Perfect. I will review your reflection before the session. Thanks Sophie!',
    'Sounds like a solid plan. Keep up the great work!',
  ],
  'th-02': [
    'Excellent — PESTLE is a great framework. Let me know if you need any clarifications.',
    'Glad you found it useful! The assignment for this module is due Wednesday.',
  ],
  'th-03': [
    'Thanks Sophie! Looking forward to hearing more at our next catch-up.',
  ],
  'th-04': [
    'We are on it! The IT team has been notified and will update you shortly.',
  ],
  default: [
...
function playNotificationSound() {
  try {
    ...
    // Silent fail — audio context not supported
  }
}
...
export default function MessagesPage() {
  ...
  const [activeThread, setActiveThread] = useState<string | null>(() => {
    ...
    if (contactParam) {
      const thread = THREADS.find(t => t.contact.id === contactParam);
  ...
  // Filter messages by chat search AND exclude deleted-for-me messages
  ...
  // Countdown timer for scheduled messages
  useEffect(() => {
  ...
  // Read receipt simulation — transition sent → delivered → read
  useEffect(() => {
  ...
  const handleSend = () => {
    ...
    const replyTarget = replyToId ? [...(SAMPLE_MESSAGES[activeThread] || []), ...(conversationMessages[activeThread] || [])].find(m => m.id === replyToId) : null;
    if (replyTarget?.deletedForEveryone) setReplyToId(null);
    const now = new Date();
    ...
    // Simulate typing + auto-reply with sound
    setIsTyping(true);
  ...
  const handleSimulateIncoming = (type: 'voice' | 'video') => {
    if (!activeThreadData?.contact.online) return;
  ...
  const handleDeclineIncoming = () => {
    ...
    const missedMsg: Message = {
      id: `missed-${Date.now()}`,
      from: 'them',
      text: `Missed ${incomingCallType} call`,
      time: timeStr,
      date: dateStr,
      status: 'read',
    ...
    setConversationMessages(prev => ({
      ...prev,
      [activeThread]: [...(prev[activeThread] || []), missedMsg],
    }));
    setIncomingCallSim(false);
  };
  ...
  const handleMuteChat = () => {
    // Toggle handled inside ChatMenu
  };
  ...
  const handleReportChat = () => {
    // Handled inside ChatMenu with toast
  };
  ...
  const handleAddReaction = (msgId: string, emoji: string) => {
    setConversationMessages(prev => {
      ...
      if (existing) {
        ...
        if (users.includes('Sophie')) {
          existing.reactions = { ...currentReactions, [emoji]: users.filter(u => u !== 'Sophie') };
          if (existing.reactions[emoji].length === 0) delete existing.reactions[emoji];
        } else {
          existing.reactions = { ...currentReactions, [emoji]: [...users, 'Sophie'] };
        }
      }
  ...
  const handleStarMessage = (msgId: string) => {
    ...
    if (starredMessageIds.has(msgId)) {
      ...
      localStorage.setItem(STARRED_KEY, JSON.stringify(existing.filter((s: { id: string }) => s.id !== msgId)));
    } else {
    ...
    window.dispatchEvent(new CustomEvent('starred-messages-changed', { detail: { msgId } }));
  };
  ...
  return (
    <WorkspaceShell
      ...
      pageTitle="Messages" pageSubtitle="Communicate with your coach, tutor, employer and fellow learners"
          ...
          {totalUnread > 0 && (
            <div className="px-4 py-2 border-b border-foreground-300/50 bg-primary-50/50">
              <p className="text-xs text-primary-700 font-medium">
                ...
                {searchQuery ? `${filteredThreads.length} result${filteredThreads.length !== 1 ? 's' : ''}` : `${totalUnread} unread message${totalUnread > 1 ? 's' : ''} from ${THREADS.filter(t => t.unread > 0).length} conversation${THREADS.filter(t => t.unread > 0).length > 1 ? 's' : ''}`}
              </p>
            </div>
          )}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-foreground-400 truncate mt-0.5">
                    {highlightText(thread.contact.role, searchQuery)}
                  </p>
            ...
            <>
              ...
              <div className={`flex items-center justify-between px-6 py-4 border-b border-foreground-300/50 shrink-0 ${getHeaderBg(activeThreadData.contact.avatarColor)}`}>
                ...
                <div className="flex items-center gap-1">
                  ...
                  {activeThreadData.contact.online && (
                    <button
                      onClick={() => handleSimulateIncoming('voice')}
                      className="w-8 h-8 rounded-lg flex items-center justify-center text-foreground-300 hover:text-emerald-500 hover:bg-emerald-50 transition-smooth cursor-pointer relative"
                      title="Simulate incoming call"
                    >
                      <AppIcon className="ri-phone-find-line text-sm"></AppIcon>
              ...
              {incomingCallSim && (
                <div className="px-6 py-4 border-b border-emerald-200/30 bg-emerald-50/80 animate-in slide-in-from-top-2 duration-300 ease-out">
                  <div className="flex items-center gap-4">
                    <div className="relative shrink-0">
                      <span className="absolute inset-0 rounded-full bg-emerald-400/30 animate-ping"></span>
                      <span className="absolute inset-0 rounded-full bg-emerald-400/20 animate-ping" style={{ animationDelay: '0.4s' }}></span>
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold ${activeThreadData.contact.avatarColor} ring-4 ring-emerald-200 animate-pulse relative z-10`}>
                        {activeThreadData.contact.initials}
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-semibold text-foreground-800">
                        {incomingCallType === 'video' ? 'Video call' : 'Voice call'} from {activeThreadData.contact.name}
                      </p>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <button
                        ...
                        className="w-11 h-11 rounded-full bg-red-500 flex items-center justify-center text-white hover:bg-red-600 transition-smooth cursor-pointer shadow-lg shadow-red-500/20 animate-in zoom-in-95 duration-200"
                        title="Decline"
                      >
                        <AppIcon className="ri-phone-fill text-lg rotate-[135deg]"></AppIcon>
                      </button>
                      <button
                        onClick={handleAcceptIncoming}
                        className="w-11 h-11 rounded-full bg-emerald-500 flex items-center justify-center text-white hover:bg-emerald-600 transition-smooth cursor-pointer shadow-lg shadow-emerald-500/20 animate-in zoom-in-95 duration-200"
                        title="Accept"
                      >
                        <AppIcon className="ri-phone-fill text-lg"></AppIcon>
                      </button>
                    </div>
                  </div>
                </div>
                    ...
                    <div key={msg.id} id={`msg-${msg.id}`} className="group">
                      ...
                      <div className={`flex ${msg.from === 'me' ? 'justify-end' : 'justify-start'}`}>
                        <div className={`max-w-[70%] ${msg.from === 'me' ? 'order-1' : ''}`}>
                          ...
                          {replyToMsg && !replyToMsg.deletedForEveryone && (
                          ...
                          {/* Reactions + Reply + Read receipt row */}
              ...
              <div className="px-6 py-4 border-t border-background-200/30 shrink-0 relative">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {/* Recorded preview (ready to send) */}
                  {!isRecording && audioUrl && (
      ...
      {showForwardModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          ...
          <div className="relative bg-background-50 rounded-2xl w-full max-w-sm mx-4 shadow-xl border border-background-200 animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between px-5 py-4 border-b border-background-200/50">
              <div className="flex items-center gap-2">
