...
export default function CoachAiMarking() {
  ...
  return (
    <WorkspaceShell role="coach" roleLabel={coachNav.label} navItems={coachNav.items} workspaceLabel={coachNav.workspaceLabel} pageTitle="AI-assisted Marking" pageSubtitle="Review AI-generated assessments and provide final scores" userName={coach.name} userRole="Progress Coach">
