              ...
              <div className="p-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-foreground-400 mt-0.5">
                      <i className="ri-calendar-check-line mr-0.5" />
                    ...
                    {form.coachComment && (
                      <div className="mt-2 bg-background-100 rounded-lg px-3 py-2 text-xs text-foreground-600 flex items-start gap-2">
                        <i className="ri-chat-1-line text-foreground-400 mt-0.5 shrink-0" />
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    {form.status === 'done' && (
                      ...
                      >
                        <i className="ri-arrow-go-back-line" /> Reopen
                      </button>
                    )}
                    <button
                    ...
                    >
                      <i className="ri-chat-1-line" /> Comment
                    </button>
                    <button
