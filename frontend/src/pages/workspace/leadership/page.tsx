      ...
      <div className="p-6 space-y-5">
          ...
          <div className="rounded-xl border border-red-200/60 bg-red-50/40 overflow-hidden">
            <button onClick={() => setAlertsExpanded(!alertsExpanded)} className="w-full flex items-center justify-between px-5 py-3 cursor-pointer">
              <div className="flex items-center gap-3">
                <span className="w-8 h-8 rounded-lg bg-red-500 flex items-center justify-center"><AppIcon className="ri-alert-fill text-white text-sm"></AppIcon></span>
              ...
              <AppIcon className={`${alertsExpanded ? 'ri-arrow-up-s-line' : 'ri-arrow-down-s-line'} text-red-400 text-sm`}></AppIcon>
            </button>
            {alertsExpanded && (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {[
            ...
            <div key={k.l} className="bg-background-50 rounded-xl border border-foreground-200/60 p-4 cursor-pointer hover:border-background-300/70 transition-smooth">
              <span className={`w-9 h-9 rounded-lg flex items-center justify-center ${k.c} mb-3`}><AppIcon className={`${k.i} text-sm`}></AppIcon></span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/cohort-performance" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">View all <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/achievement-pipeline" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">View all <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
            <div className="space-y-2.5">
              {[
                ...
                <div key={s.label} className="flex items-center gap-3">
                  <span className={`w-7 h-7 rounded-lg ${s.color} flex items-center justify-center shrink-0`}><AppIcon className={`${s.icon} text-white text-xs`}></AppIcon></span>
                  ...
                  {i < 5 && <span className="text-foreground-300 text-[10px]"><AppIcon className="ri-arrow-right-line"></AppIcon></span>}
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/leadership/attendance-trends" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">Attendance <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/otjh-trends" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">Full report <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/ksb-progress" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">Drill down <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/tutor-sla" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">Full SLA <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
            <div className="space-y-3">
              {TUTORS.map(t => (
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/coach-workload" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">Full analysis <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
            <div className="space-y-3">
              {COACHES.map(c => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/compliance-risk" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">Full matrix <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
          ...
          <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/leadership/qa-sampling" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">View QA <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
            </div>
            <div className="space-y-3">
              {/* QA Summary */}
              ...
              <Link to="/leadership/ofsted" className="block p-3 rounded-lg border border-foreground-200 hover:border-primary-200/60 transition-smooth cursor-pointer">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="compact-action text-[9px] font-semibold text-primary-500">View pack <AppIcon className="ri-arrow-right-line text-[8px]"></AppIcon></span>
                </div>
        ...
        <div className="bg-background-50 rounded-xl border border-foreground-200/60 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link to="/leadership/employer-engagement" className="compact-action text-[10px] font-semibold text-primary-500 hover:text-primary-600">Full engagement <AppIcon className="ri-arrow-right-line text-[9px]"></AppIcon></Link>
          </div>
